...
function Tables() {
  ...
  const fetchStudents = async () => {
    try {
      const response = await axios.get('https://joyous-ocean-production.up.railway.app/api/students');
  ...
  const createStudent = async () => {
    try {
      await axios.post('https://joyous-ocean-production.up.railway.app/api/students', newStudent);
  ...
  const updateStudent = async () => {
    try {
      await axios.put(`https://joyous-ocean-production.up.railway.app/api/students/${editingStudent.id}`, editingStudent);
  ...
  const deleteStudent = async (id) => {
    try {
      await axios.delete(`https://joyous-ocean-production.up.railway.app/api/students/${id}`);
      fetchStudents();
    } catch (error) {
