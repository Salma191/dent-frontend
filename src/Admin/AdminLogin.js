...
const AdminLogin = ({ onLogin }) => {
  ...
  const getUserData = async () => {
    ...
    if (userId) {
      const response = await axios.get(`https://joyous-ocean-production.up.railway.app/api/admins/${userId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.get(`https://joyous-ocean-production.up.railway.app/api/admins/login/${userName}`);
